...
public class RunAnalysis {
    ...
    public static void main(String[] args) {
        ...
        EventsUtils.readEvents(manager, "D:\\Users\\chris\\Documents\\CSDSchool\\MatSimClass\\projects\\velbert\\scenarios\\velbert-v1.0-1pct\\cluster-outputs\\run11\\velbert-v1.0-1pct11.output_events.xml.gz");
        ...
        try (var writer = Files.newBufferedWriter(Paths.get("D:\\Users\\chris\\Documents\\CSDSchool\\MatSimClass\\projects\\velbert\\scenarios\\velbert-v1.0-1pct\\modalshares\\run11\\modes-events-velbert11.csv")); var printer = CSVFormat.DEFAULT.withDelimiter(',').withHeader("Mode", "Count", "Share").print(writer)) {
